      ...
      <div class="main">
          ...
          <div class="List">
              ...
              <table id="productTable">
                  <thead>
                      <th class="num first" >编号</th>
                      <th class="name first" >商品名称</th>
                      <th class="pic first" >商品头图</th>
                      <th class="pict first" >商品图片</th>
                      <th class="det first" >商品简介</th>
                      <th class="numb first" >数量</th>
                      <th class="price first" >价格</th>
                  ...
                  <c:forEach items="${page.list}" var="p">
                      ...
                      <tr>
                          ...
                          <td class="operation" >
                              <c:if test="${p.status!=2}">
                                  <button onclick="pstatus('${p.id}','0','下架')">下架</button>
                                  <button onclick="pstatus('${p.id}','1','上架')">上架</button>
                          <%--    <a href="detailProductManage.do?productId=${p.id}">修改</a>--%>
                              </c:if>
                              <c:if test="${p.status==2}">
                                  <a onclick="delproduct(${p.id})" >取消删除</a>
                              </c:if>
                          </td>
                      </tr>
...
<script>
    function pstatus(id,a,b) {
       if(confirm("是否"+b)) {
           $.post("setSaltProductManage.do", {"productId": id, "status": a}, function (data) {
    ...
    function delproduct(id) {
        $.post("delproduct.do", {"id": id}, function (data) {
