              ...
              <table>
                  ...
                  <c:forEach items="${page.list}" var="o">
                      <tr>
                          ...
                          <td class="pic">
                              <img src="upload/${o.orderItemVoList[0].productImage}" style="height: 70px;width: 70px"/>
                          </td>
                          ...
                          <td rowspan="${fn:length(o.orderItemVoList)}">
                              ...
                              <c:if test="${o.status==10}">
                                  <input type="button" onclick="ostatus('${o.orderNo}',20,'支付')"  value="支付">
                              </c:if>
                      ...
                      <c:forEach begin="1" items="${o.orderItemVoList}" var="p">
                          <tr>
                              <td class="pic">
                                  <img src="upload/${p.productImage}"  style="height: 70px;width: 70px"/>
                              </td>
