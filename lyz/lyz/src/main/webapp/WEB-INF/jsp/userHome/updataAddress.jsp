...
<div class="main">
    ...
    <div class="List">
        ...
        <div class="city">
          <input value="${data.id}" name="id" hidden="hidden">
            姓名：<input type="text" id="na" value="${data.receiverName}" name="receiverName">
        </div>
        <div class="phone">
            电话：<input type="tel" id="ph" value="${data.receiverPhone}" name="receiverPhone">
        </div>
        <div class="city">
            省份：<input type="text" id="provinces" value="${data.receiverProvince}" name="receiverProvince">&nbsp&nbsp&nbsp&nbsp
            城市：<input type="text" id="city" value="${data.receiverCity}" name="receiverCity">
        </div>
        <div class="addressDetail">
            详细地址：<br/><textarea id="address"   name="receiverAddress">${data.receiverAddress}</textarea>
        </div>
