        ...
        <table>
          ...
          <%--          <td class="activity" >双十二</td>--%>
                   <%-- <td class="type" ></td>--%>
                    ...
                    <td class="operation" >
                        <a href="/delGoodAct?actId=${actId}&goodsId=${p.id}">删除</a><br>
                    </td>
                </tr>
           ...
           <tr>
               <div class="page-normal" >
                   <a href="/delActProductPage?pageNum=${page.prePage}">&nbsp;&lt;&nbsp;</a>

                   <c:forEach  var="s"   begin="1" end="${page.pages}"  >
                       <a href='/delActProductPage?pageNum=${s}'>${s}</a>
                   </c:forEach>
                   <a href="/delActProductPage?pageNum=${page.nextPage}">&nbsp;&gt;&nbsp;</a>
               </div>
           </tr>
        </table>
    </div>
