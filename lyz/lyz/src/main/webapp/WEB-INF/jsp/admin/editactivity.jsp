...
<div class="main">
    <div class="set">
        <p>商城活动设置<a href="/admin/editactivity.jsp">新增</a></p>
        <form method="" action="saveAct"  accept-charset="UTF-8">
          <input id="id" type="text" name="id" value="${a.id}" hidden="hidden">
        活动名称 : <input id="activityName" type="text" name="activityName" value="${a.activityName}">
          <br>
         活动详情: <input id="content" type="text" name="content" value="${a.content}">
            <br>
         活动状态: <input id="state" type="text" name="state" value="${a.state}">
            <br>
   <%--     <input id="starttime" type="date" name="starttime" value="${a.starttime}">
        <input id="updatetime" type="date" name="updatetime" value="${a.updatetime}">--%>
