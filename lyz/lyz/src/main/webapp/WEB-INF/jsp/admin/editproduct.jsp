...
<div class="main">
    ...
    <div class="List">
        ...
        <form action="/saveProductManage.do" method="post" enctype="multipart/form-data">
         ...
         商品名称:<input type="text" name="name" value="${product.name}">
            ...
            商品库存:<input type="text" value="${product.stock}" name="stock">
            <br />
            商品价格:<input type="text" name="price" value="${product.price}" >
            <br />
            商品主图:<input type="file"  value="upload/${product.mainImage}" name="multiUploadFiles[0]">
            <br />
            <div id="addFileDiv">
            ...
            <br />
            商品描述:<input type="text" name="detail" value="${product.detail}">
            <br />
