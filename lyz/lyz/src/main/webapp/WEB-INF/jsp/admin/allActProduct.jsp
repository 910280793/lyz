        ...
        <table>
          ...
          <%--          <td class="activity" >双十二</td>--%>
                   <%-- <td class="type" ></td>--%>
                    ...
                    <td class="operation" >
                        <a href="/addGoodAct.do?actId=${actId}&goodsId=${p.id}">添加</a><br>
                    </td>
                </tr>
           ...
           <tr>
               <div class="page-normal" >
                   <a href="/addActProductPage?pageNum=${page.prePage}">&nbsp;&lt;&nbsp;</a>

                   <c:forEach  var="s"   begin="1" end="${page.pages}"  >
                       <a href='/addActProductPage?pageNum=${s}'>${s}</a>
                   </c:forEach>
                   <a href="/addActProductPage?pageNum=${page.nextPage}">&nbsp;&gt;&nbsp;</a>
               </div>
           </tr>
        </table>
    </div>
